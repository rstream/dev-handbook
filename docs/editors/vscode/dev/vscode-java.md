...
[Instruction for Linux](../../../operating-systems/linux/dev/linux-java.md) - Install JDK for Linux  
[Instruction for Windows](../../../operating-systems/windows/dev/windows-java.md) - Install JDK for Windows

## 2 Install VS Code extension

Install the extension `Extension Pack for Java` (official from Microsoft)
